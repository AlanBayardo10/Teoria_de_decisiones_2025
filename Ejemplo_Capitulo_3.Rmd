...
probabilidad_j <- function(Vi, Vj, B = 1) {
  ...
  ggplot() +
    geom_function(fun = fv_den, color = "darkorange", linewidth = 0.5, xlim = c(-B - 0.1, B + 0.1)) +
    stat_function(fun = fv_den, geom = "area", fill = "darkolivegreen", alpha = 0.5, xlim = c(-B, Vji)) +
...
ggplot() +
  geom_line(aes(x, y), color = "cyan", linewidth = 1.5) +
  geom_function(fun = fv_den, color = "deeppink", linewidth = 0.5) +
  xlim(-1.5, 1.5) +
...
decision <- function(Vj, Vi, B = 1) {
  ...
  ggplot() +
    geom_function(fun = fv_den, color = "firebrick", linewidth = 0.5, xlim = c(-B - 0.1, B + 0.1)) +
    stat_function(fun = fv_den, geom = "area", fill = "gold", alpha = 0.5, xlim = c(-B, Vji)) +
